...
See https://mvnrepository.com/artifact/com.duosecurity/duo-client/0.7.1 for more details.
...
```
$ java -jar duo-example-admin-0.7.1-jar-with-dependencies.jar -host <host> -ikey <ikey> -skey <skey>
```
